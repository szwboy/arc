...
public class JavassistClassGenerator {
	...
	public static JavassistClassGenerator newInstance(ClassLoader cl){
		
		return new JavassistClassGenerator(getClassPool(cl));
	}
	
	private JavassistClassGenerator(ClassPool cp){
